...
export default async function Home() {
  return (
    <main className="flex flex-col gap-10 flex-1 items-center justify-center px-48">
      <section className="text-white text-5xl text-center xl:text-5xl lg:text-4xl md:text-3xl">
        Explore o Universo do Front-End: Receba as últimas tendências, dicas e truques toda semana!</section>
      <section className="text-white text-lg text-center xl:text-lg lg:text-base md:text-sm">
